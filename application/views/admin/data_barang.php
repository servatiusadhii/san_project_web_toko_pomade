<div class="container-fluid">
	...
	<table class="table table-border">
      ...
      <td><?php echo anchor('admin/data_barang/detail/' .$brg->id_brg, '<div class="btn btn-sm btn-success"><i class="fas fa-search-plus"></i></div>') ?></td>
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(). 'admin/data_barang/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
        	...
        	<div class="form-group">
              ...
              <option>---</option>
              <option>Pomade Local</option>
              <option>Pomade Interlocal</option>
            </select>
        	</div>
        	<div class="form-group">
        		<label>Harga</label>
